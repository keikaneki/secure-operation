<?php
	...
	$_SESSION['DEMO'] = 		isset($_POST['demo']) ? implode(" / ", $_POST["demo"]) : '';
...
<!-- End Google Tag Manager -->
	...
	<title>確認｜資料ダウンロード｜SECURE AI Office Base：社員を守り、事業も継続！オフィスはクラウドで管理する</title>
  ...
  <div id="wrap">
	...
	<section class="formsection">
		...
		<article>
			...
			<!--<dl>
				<dt class="any">部署名</dt>
				<dd><?php print($_SESSION['DEPARTMENT']) ?></dd>
			</dl>-->
			<dl>
				<dt class="req">お名前</dt>
