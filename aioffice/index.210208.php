...
<!-- End Google Tag Manager -->
	...
	<title>SECURE AI Office Base：社員を守り、事業も継続！ニューノーマル時代のリモート×AI職場運用システム</title>
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrap">
		<div id="mv" class="dl2_index">
			...
			<div class="dl2">
				<a href="javascript:window.location.href='./docs/toranomaki02/' + param;">
					<div class="inner">
			...
			<div id="mv__inner" class="txt_up"><div><p><a class="btn youtube-modal" href="https://www.youtube.com/embed/1id3_e4XGck?autoplay=1&loop=1&playlist=1id3_e4XGck&amp;wmode=transparent"><img src="./images/icon_video.svg" width="26" /><span>動画での説明を見る</span></a></p></div></div>
		...
		<div id="bottom_btn">
			...
			<picture>
				...
				<source media="(max-width:640px)" srcset="/aioffice/images/btn_aioffice_dl_sp.jpg 870w">
					<a href="/aioffice/#form"><img srcset="/aioffice/images/btn_aioffice_dl_sp.jpg 870w, /aioffice/images/btn_aioffice_dl.jpg 2000w" alt="ニューノーマル時代のオフィスのあり方虎の巻　無料ダウンロード"></a>
			</picture>
		</div>
		<!-- free download end -->
