			...
			<div id="form_b">
				...
				<div class="inner">
					...
					<section class="formsection">
						<form id="formarea_b" action="https://contents.bownow.jp/forms/handler/sid_4f38ed46fd0f20621af9" method="POST" accept-charset="UTF-8" >
							...
							<dl>
								...
								<dd class="mt">
									...
									<input type="checkbox" name="demo_b" id="demockbox" v-model="demo_b" value="デモを希望する" @change="democng_b"><label for="demockbox">ショールーム見学もしくはデモ希望（日本全国対応）</label>
								</dd>
							</dl>
							...
							<dl>
								...
								<dd class="mt">
									...
									<input type="checkbox" name="agree_b" id="ckbox" v-model="agree_b" :value="agree_b" @change="agreecng_b"><label for="ckbox">同意する</label>
			...
			<div id="form">
				<div class="scroll">
					...
					<div class="inner">
						...
						<section class="formsection">
							<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_050e9139ac977a6fdd14" method="POST" accept-charset="UTF-8" >
