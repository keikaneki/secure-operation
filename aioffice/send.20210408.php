...
//		$mailtoAddress = "maki@kau-design.com";
		$mailtoAddress = "info_guarden@secureinc.co.jp";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【AI Office Base】 よりお問合せがありました";
				$thxmes = "お問い合わせありがとうございました\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					...
					"【 お問い合わせ種別 】 ". 			mb_convert_kana($_SESSION['KIND'],"aK") . "\n".
		...
		if ( $mail->send() ) {
			$mail->ClearAddresses();
			$mail->FromName		= mb_encode_mimeheader($fromUserName,"ISO-2022-JP","UTF-8"); // "表示名" <メールアドレス>
			$mail->Subject		= mb_encode_mimeheader("【AI Office Base】 お問合せありがとうございます","ISO-2022-JP", "UTF-8");
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./index.php#form">お問い合わせフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./index.php#form">お問い合わせフォームに戻る</a></p>
...
?>
			...
			<p class="tocontact"><a href="./index.php#form" class="btn"><span>お問い合わせフォーム</span></a></p>
		</article>
