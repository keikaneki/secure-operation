...
<!-- End Google Tag Manager -->
	...
	<title>クラウド型 AI顔認証・入退室管理 SECURE AI Office Base</title>
	<meta name="description" content="職場はクラウドで管理する。AI顔認証・入退室管理の「SECURE AI Office Base」。ABWや職場3密対策に！" />
	<meta name="keywords" content="ABW,職場3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,職場リモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="クラウド型 AI顔認証・入退室管理 SECURE AI Office Base｜職場はクラウドで管理する" />
	...
	<meta property="og:site_name" content="クラウド型 AI顔認証・入退室管理 SECURE AI Office Base｜職場はクラウドで管理する" />
		...
		<main>
			<div id="mv" class="dl2_index">
				...
				<div id="mv__inner" class="txt_up">
					...
					<div>
						<h1> <span>AI顔認証でクラウド入退室管理<br>測温・マスク検知・3密対策も</span></h1>
