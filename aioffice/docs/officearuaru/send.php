...
<!-- End Google Tag Manager -->
	...
	<title>完了｜オフィス運用あるある図鑑｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、オフィス運用あるある図鑑無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="オフィス運用あるある図鑑｜資料ダウンロード｜SECURE AI Office Base" />
	...
	<meta property="og:description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、オフィス運用あるある図鑑無料資料ダウンロード" />
...
//		$mailtoAddress = "nac@monotribe.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【AI Office Base】 オフィスあるある図鑑ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/officearuaru/officearuaru_wp.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					...
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/officearuaru/officearuaru_wp.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/officearuaru/officearuaru_wp.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/officearuaru/officearuaru_wp.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
