...
<!-- End Google Tag Manager -->
	...
	<title>オフィス運用あるある図鑑｜資料ダウンロード｜SECURE AI Office Base</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">総務さん必見！オフィス運用あるある図鑑<br />　〜なんとかならないの？が導き出せる〜</span></h1>
		  <figure><img src="./doc_thumbnail_aruaru.png" width="306" height="238">
		  	<figcaption style="color:#000;">総務さんの職場・オフィス運用におけるよくある事例と、それの解決方法を図鑑にまとめました。<br />
		  	セキュリティ、入退室管理、退職者管理と入った基本的な管理をはじめ、感染症対策でのマスク管理、体調管理、非接触の顔認証といった様々な課題があると思います。それらの課題を解決するためのお手伝いとなるべくよくある事例をあるあるとしてまとめ、その対策方法のご提案をしておりますので、是非ご一読いただければ幸いです。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_8d1de1ba7870707432bd" method="POST" accept-charset="UTF-8" >
