...
<!-- End Google Tag Manager -->
	...
	<meta name="description" content="店舗計測の活用事例の無料資料ダウンロード" />
	...
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/store-measurement/" />
	<meta property="og:site_name" content="SECURE AI Office Base：社員を守り、事業も継続！職場はクラウドで管理する" />
	<meta property="og:description" content="店舗計測の活用事例の無料資料ダウンロード" />
...
//		$mailtoAddress = "yoyuya@gmail.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】店舗計測の活用事例ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/store-measurement/store_measurment.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/store-measurement/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/store-measurement/store_measurment.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/store-measurement/store_measurment.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/store-measurement/store_measurment.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../store-measurement/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../store-measurement/">資料ダウンロードフォームに戻る</a></p>
