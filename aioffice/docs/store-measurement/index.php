...
<!-- End Google Tag Manager -->
	...
	<title>店舗計測の活用事例｜資料ダウンロード｜株式会社セキュア</title>
	<meta name="description" content="株式会社セキュアがお届けする、店舗計測の活用事例資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">店舗計測の活用事例<br><span style="font-size:65%;">リアル店舗の顧客と商品をデータで可視化</span></span></h1>
		  <figure><img src="./doc_thumbnail_storemeasurement.png" width="306">
		  	<figcaption style="color:#000;">株式会社セキュアが運営する未来型無人化店舗[SECURE AISTORELAB]での知見を元にこれからの店舗データ活用例をご紹介。<br>AI顔認証カメラによる棚解析や来客分析、ロス削減や業務効率化や監視カメラでのセキュリティ高度化など新しい店舗管理の指針をご提示します。</figcaption></figure>
		</div>
	  </div>
	</div>
