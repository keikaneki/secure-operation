...
<!-- End Google Tag Manager -->
	...
	<title>SECURE ACaaS資料｜資料ダウンロード｜SECURE ACaaS</title>
	<meta name="description" content="SECURE ACaaSの無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE ACaaS,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="SECURE ACaaS資料｜資料ダウンロード｜SECURE ACaaS" />
	<meta property="og:image" content="https://secureinc.co.jp/aioffice/docs/aiob3min/doc_thumbnail_aiobov.png" />
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/aiob3min/" />
	<meta property="og:site_name" content="SECURE ACaaS：社員を守り、事業も継続！職場はクラウドで管理する" />
	<meta property="og:description" content="SECURE ACaaSの無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">SECURE ACaaS 資料<br /><span style="font-size:60%;">〜東証上場記念キャンペーン実施中〜</span></span></h1>
		  <figure><img src="./acaas_thumb.png" width="180">
		  	<figcaption style="color:#000;">顔認証クラウド型入退室管理システムSECURE ACaaSの月額使用料が「0」円</figcaption></figure>
		</div>
	  </div>
	</div>
