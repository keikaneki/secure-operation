...
<!-- End Google Tag Manager -->
	...
	<title>完了｜資料ダウンロード｜SECURE ACaaS</title>
	<meta name="description" content="簡単導入！顔認証クラウド型入退室管理システムSECURE ACaaSの無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE ACaaS,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="資料ダウンロード｜SECURE ACaaS" />
	...
	<meta property="og:site_name" content="SECURE ACaaS：社員を守り、事業も継続！職場はクラウドで管理する" />
	<meta property="og:description" content="簡単導入！顔認証クラウド型入退室管理システムAI Offce Baseの無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <header>
		<h2>
			<a href="../../campaign.php"><img src="../../images/acaas_logo.png" alt="SECURE ACaaS" width="256" /></a></h2>
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/acaas/". "\n".
		...
		if ( $mail->send() ) {
			$mail->ClearAddresses();
			$mail->FromName		= mb_encode_mimeheader($fromUserName,"ISO-2022-JP","UTF-8"); // "表示名" <メールアドレス>
			$mail->Subject		= mb_encode_mimeheader("【SECURE ACaaS】 資料ダウンロードありがとうございます","ISO-2022-JP", "UTF-8");
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/ACaaS_campaign.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/ACaaS_campaign.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../aiob3min/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../aiob3min/">資料ダウンロードフォームに戻る</a></p>
