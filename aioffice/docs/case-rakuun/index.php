...
<!-- End Google Tag Manager -->
	...
	<title>事例大宮ラクーン様｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、大宮ラクーン様の導入事例無料資料ダウンロード" />
	...
	<meta property="og:description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、大宮ラクーン様の導入事例無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">AI×監視カメラ×顔認証技術で<br />安全な施設づくりと管理効率化を実現<br />事例紹介大宮ラクーン様</span></h1>
		  <figure><img src="./doc_thumbnail_caserakuun2.png" width="306" height="238">
		  	<figcaption style="color:#000;">商業施設の新しいあり方、より安全な施設づくりと管理効率化を目指す中で最新のデジタルテクノロジーを採用。<br />
		  	AIと監視カメラと顔認証技術を活用し安全でかつ管理の効率化を実現した手法をご紹介。今後は来館者の数や行動導線などマーケティング活用なども視野に。</figcaption></figure>
		</div>
	  </div>
	</div>
