...
<!-- End Google Tag Manager -->
	...
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする株式会社セキュアがお届けする、入退室管理システムの必要性と導入ステップ資料ダウンロード" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする株式会社セキュアがお届けする、入退室管理システムの必要性と導入ステップ資料ダウンロード" />
...
//		$mailtoAddress = "yoyuya@gmail.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 入退室管理導入ステップダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/ac-step/wp-ac-step.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/ac-step/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/ac-step/wp-ac-step.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/ac-step/wp-ac-step.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/ac-step/wp-ac-step.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../ac-stept/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../ac-step/">資料ダウンロードフォームに戻る</a></p>
