...
<!-- End Google Tag Manager -->
	...
	<title>入退室管理システムの必要性と導入ステップ｜資料ダウンロード｜株式会社セキュア</title>
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする入退室管理システムの必要性と導入ステップ無料資料ダウンロード" />
	<meta name="keywords" content="入退室管理,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="入退室管理システムの必要性と導入ステップ｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする入退室管理システムの必要性と導入ステップ無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">入退室管理システムの必要性と導入ステップ<br />資料ダウンロード</span></h1>
		  <figure><img src="./doc_thumbnail_ac-step.png" width="306">
		  	<figcaption style="color:#000;">入退室管理システム導入時に検討が必要な利用用途、認証方式、人数やドア数などの利用環境、セキュリティレベルなどポイントなどの導入ステップを分かりやすくまとめました。<br />これからシステムを検討したい、入退室の管理に課題を持たれている方、これからオフィス・職場の移転を考えている方はぜひご活用ください。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
			<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_194490cf0ec94ad6a102" method="POST" accept-charset="UTF-8" >
