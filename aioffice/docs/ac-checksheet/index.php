...
<!-- End Google Tag Manager -->
	...
	<title>入退室管理 導入前チェックシート｜資料ダウンロード｜株式会社セキュア</title>
	...
	<meta property="og:title" content="入退室管理 導入前チェックシート｜資料ダウンロード｜株式会社セキュア" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">入退室管理 導入前チェックシート</span></h1>
		  <figure><img src="./doc_thumbnail_checksheet.png" width="306">
		  	<figcaption style="color:#000;">入退室管理システム導入時に必要なチェック項目を5つのステップにまとめました。これからシステムを検討したい、入退室の管理に課題を持たれている方、これからオフィス・職場の移転を考えている方はぜひご活用ください。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_892f4bbee8ce3afe70f5" method="POST" accept-charset="UTF-8" >
			<!--<dl>
