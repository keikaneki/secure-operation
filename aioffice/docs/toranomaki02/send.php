...
//		$mailtoAddress = "nac@monotribe.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/toranomaki02/toranomaki_02.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					...
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/toranomaki02/toranomaki_02.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/toranomaki02/toranomaki_02.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/toranomaki02/toranomaki_02.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
