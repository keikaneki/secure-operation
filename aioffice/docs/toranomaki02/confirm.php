...
<!-- End Google Tag Manager -->
	...
	<title>確認｜資料ダウンロード｜SECURE AI Office Base：社員を守り、事業も継続！職場はクラウドで管理する</title>
	<meta name="description" content="ABWやオフィス3密対策に！職場はクラウドで管理する。入退室管理、顔認証の「SECURE AI Office Base」を提供いたします。" />
	...
	<meta property="og:description" content="ABWやオフィス3密対策に！職場はクラウドで管理する。入退室管理、顔認証の「SECURE AI Office Base」を提供いたします。" />
