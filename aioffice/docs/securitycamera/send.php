...
<!-- End Google Tag Manager -->
	...
	<title>完了｜【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド｜資料ダウンロード｜株式会社セキュア</title>
	<meta name=”robots” content=”noindex” />
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド無料資料ダウンロード" />
	<meta name="keywords" content="入退室管理,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド無料資料ダウンロード" />
...
//		$mailtoAddress = "yoyuya@gmail.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 防犯カメラ&入退室管理施設別導入・活用ガイドダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/securitycamera/facility-specific-guide.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					...
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/securitycamera/facility-specific-guide.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/securitycamera/facility-specific-guide.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/securitycamera/facility-specific-guide.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
