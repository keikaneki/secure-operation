...
<!-- End Google Tag Manager -->
	...
	<title>【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">防犯設備士監修!!<br>【防犯カメラ&amp;入退室管理】施設別導入・活用ガイド</span></h1>
		  <figure><img src="./doc_thumbnail_seccam.png" width="306">
		  	<figcaption style="color:#000;">オフィスや店舗など、設置する施設によって物理セキュリティ対策方法も変わっていきます。<br>
導入場所・施設に応じた物理セキュリティ対策を、防犯設備士監修の元で導入ポイントのご紹介をいたします。</figcaption></figure>
		</div>
	  </div>
	</div>
