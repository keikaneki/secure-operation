...
<!-- End Google Tag Manager -->
	...
	<title>測温の注意点について｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、測温の注意点について無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="事例大宮ラクーン様｜資料ダウンロード｜SECURE AI Office Base" />
	...
	<meta property="og:description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、測温の注意点について無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">正確測温で安心安全を！<br />機器選定の注意点や失敗ポイントをご紹介</span></h1>
		  <figure><img src="./doc_thumbnail_sokuonflyer.png" width="306">
		  	<figcaption style="color:#000;">感染症対策やクラスターを出さない対策の一つとして測温機器に注目が集まっています。<br />
		  	ただ、機器によっては屋外や計測距離等の使用状況により正確に測れないケースもあり、「測温機器を導入したいのだけど、どのような機器を選べばいいのかわからない」というお悩みをお持ちの方に、セキュアが長年培ってきたセキュリティカメラやデバイスの販売経験に基づき機器選定の注意点についてまとめました。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_48c23a3cc491140457d8" method="POST" accept-charset="UTF-8" >
