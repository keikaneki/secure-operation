...
<!-- End Google Tag Manager -->
	...
	<title>監視カメラシステムの必要性と導入ステップ｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">監視カメラシステムの必要性と導入ステップ</span></h1>
		  <figure><img src="./doc_thumbnail_scstep.png" width="306">
		  	<figcaption style="color:#000;">監視カメラは企業内、大型店舗、街中や電車などの公共施設などでは犯罪の抑止力や取引先からの信用評価だけでなく、社員の行動確認や従来の監視用途に加えマーケティングや画像解析にも活用されるようになってきています。<br>
本資料では監視カメラの種類や構成パターン、最新の活用方や導入のステップをご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_638786609b2b5157e23e" method="POST" accept-charset="UTF-8" >
