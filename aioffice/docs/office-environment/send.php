...
<!-- End Google Tag Manager -->
	...
	<title>完了｜「Withコロナ」時代のオフィスワーク〜新しいオフィスの提案・セキュア編〜｜資料ダウンロード｜株式会社セキュア</title>
	<meta name="description" content="株式会社セキュアがお届けする、「Withコロナ」時代のオフィスワーク無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="「Withコロナ」時代のオフィスワーク〜新しいオフィスの提案・セキュア編〜｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="株式会社セキュアがお届けする、「Withコロナ」時代のオフィスワーク無料資料ダウンロード" />
...
//		$mailtoAddress = "nac@monotribe.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 「Withコロナ」時代のオフィスワークダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/office-environment/withcorona_office_wp.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/office-environment/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/office-environment/withcorona_office_wp.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/office-environment/withcorona_office_wp.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/office-environment/withcorona_office_wp.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../toranomaki02/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../toranomaki02/">資料ダウンロードフォームに戻る</a></p>
