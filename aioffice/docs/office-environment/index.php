...
<!-- End Google Tag Manager -->
	...
	<title>「Withコロナ」時代のオフィスワーク〜新しいオフィスの提案・セキュア編〜｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">「Withコロナ」時代のオフィスワーク<br />〜新しいオフィスの提案・セキュア編〜</span></h1>
		  <figure><img src="./doc_thumbnail_officeenv.png" width="306">
		  	<figcaption style="color:#000;">私たちは社員の健康を第⼀に考えながら、「Withコロナ対策」に取り組んでおります。今回はその対策の⼀部をご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_14a9ee5fe7e8abfd267e" method="POST" accept-charset="UTF-8" >
