...
<!-- End Google Tag Manager -->
	...
	<title>資料ダウンロード｜SECURE AI Office Base：社員を守り、事業も継続！オフィスはクラウドで管理する</title>
	...
	<meta property="og:title" content="資料ダウンロード｜SECURE AI Office Base：社員を守り、事業も継続！オフィスはクラウドで管理する" />
	<meta property="og:image" content="https://secureinc.co.jp/aioffice/images/og.png" />
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/toranomaki/" />
	<meta property="og:site_name" content="資料ダウンロード｜SECURE AI Office Base：社員を守り、事業も継続！オフィスはクラウドで管理する" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">ニューノーマル時代のオフィスあり方虎の巻<br>無料ダウンロード</span></h1>
		  <figure><img src="../../images/doc_thumbnail_pages.png" width="306" height="238">
		  	<figcaption style="color:#000;">今オフィスのあり方が大きく転換を求められている時代です。<br />
		  	デジタル化がすすみテレワークの浸透もしていますが、実際のところ業務的にオフィス出社する必要があったり、テレワークとオフィス出社のハイブリット運用であったり、サテライトオフィス導入といった分散化をするなど様々なオフィス運用が試されています。<br />
	...
	<section class="formsection">
		...
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_0ba09be22e9a21706c97" method="POST" accept-charset="UTF-8" >
