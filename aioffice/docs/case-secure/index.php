...
<!-- End Google Tag Manager -->
	...
	<title>セキュア導入事例集｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、導入事例無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="セキュア導入事例集｜資料ダウンロード｜SECURE AI Office Base" />
	<meta property="og:image" content="https://secureinc.co.jp/aioffice/images/og.png" />
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/case-rakuun/" />
	<meta property="og:site_name" content="SECURE AI Office Base：社員を守り、事業も継続！職場はクラウドで管理する" />
	<meta property="og:description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、導入事例無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">AI×監視カメラ×顔認証技術<br />様々なシーンで活用いただいているセキュアの製品・ソリューションの事例ご紹介</span></h1>
		  <figure><img src="./doc_thumb_case.png" width="306" height="238">
		  	<figcaption style="color:#000;">AIと監視カメラと顔認証技術などの活用でセキュリティ面での安心・管理の効率化を実現する手法をご紹介。<br />メルカリ様、スマートニュース様、GA technologies様、アダストリア様、ラクスル様、松戸天然泉 雅楽の湯(うたのゆ)様といった、オフィス空間から商業・娯楽施設といった様々なシーンでの課題解決のための最新デジタルテクノロジー活用事例集です。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_22f82bb180c0a167c785" method="POST" accept-charset="UTF-8" >
