...
<!-- End Google Tag Manager -->
	...
	<title>SECURE Fitness Total Solution｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">〜24時間営業や無人型店舗のフィットネス ジムの課題を解決する〜<br>
SECURE Fitness Total Solutionのご紹介</span></h1>
		  <figure><img src="./doc_thumbnail_fitness.png" width="306">
		  	<figcaption style="color:#000;">24時間営業や無人型施設をはじめとしたフィットネス・ジムに特化したソリューションをご紹介。<br>
施設内の遠隔モニタリングや混雑度状況の会員通知といった状況管理から、会員の利用時間や共連れ防止といった会員の管理、コロナ対策や夜間の無人営業セキュリティ対策といった様々なフィットネス・ジム運用シーンの課題解決をサポートいたします。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_3a88b90b2384cb12709a" method="POST" accept-charset="UTF-8" >
