...
<!-- End Google Tag Manager -->
	...
	<title>完了｜SECURE Fitness Total Solution｜資料ダウンロード｜株式会社セキュア</title>
	<meta name=”robots” content=”noindex” />
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けするSECURE Fitness Total Solution無料資料ダウンロード" />
	<meta name="keywords" content="入退室管理,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="SECURE Fitness Total Solution｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けするSECURE Fitness Total Solution無料資料ダウンロード" />
...
//		$mailtoAddress = "yoyuya@gmail.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 SECURE Fitness Total Solutionダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/fitness-solution/flyer_SECURE_fitness-solution.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/fitness-solution/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/fitness-solution/flyer_SECURE_fitness-solution.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/fitness-solution/flyer_SECURE_fitness-solution.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/fitness-solution/flyer_SECURE_fitness-solution.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../fitness-solution/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../fitness-solution/">資料ダウンロードフォームに戻る</a></p>
