...
<!-- End Google Tag Manager -->
	...
	<title>SECURE AI Office Base 概要資料｜資料ダウンロード｜SECURE AI Office Base</title>
	...
	<meta property="og:title" content="SECURE AI Office Base 概要資料｜資料ダウンロード｜SECURE AI Office Base" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">SECURE AI Office Base 概要資料<br /><span style="font-size:60%;">〜顔認証でクラウド入退室管理＆測温マスク検知3密対策ノウハウ〜</span></span></h1>
		  <figure><img src="./doc_thumbnail_aiobov.png" width="306" height="238">
		  	<figcaption style="color:#000;">簡単導入！顔認証クラウド型入退室管理システム。<br />
		  	新しいワークスタイルを支援する顔認証クラウド型入退室管理システムの概要資料です。ご検討のための資料としてぜひご活用ください。</figcaption></figure>
		</div>
	  </div>
	</div>
