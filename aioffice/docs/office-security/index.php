...
<!-- End Google Tag Manager -->
	...
	<title>3分で分るあなたのオフィスセキュリティ対策｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">3分で分るあなたのオフィスセキュリティ対策</span></h1>
		  <figure><img src="./doc_thumbnail_officesec.png" width="306">
		  	<figcaption style="color:#000;">営業時間中の「ひと」を対象した物理セキュリティ対策は遅れているのが実情です。その為に情報漏洩、部外者侵⼊によるリスク管理が問われるようになっています。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_e1fb7ecbaa6d05123a5a" method="POST" accept-charset="UTF-8" >
