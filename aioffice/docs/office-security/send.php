...
<!-- End Google Tag Manager -->
	...
	<title>完了｜3分で分るあなたのオフィスセキュリティ対策｜資料ダウンロード｜株式会社セキュア</title>
	<meta name="description" content="株式会社セキュアがお届けする、3分で分るあなたのオフィスセキュリティ対策無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="3分で分るあなたのオフィスセキュリティ対策｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="株式会社セキュアがお届けする、3分で分るあなたのオフィスセキュリティ対策無料資料ダウンロード" />
...
//		$mailtoAddress = "nac@monotribe.com";
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 3分で分るあなたのオフィスセキュリティ対策ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/office-security/3min_office_security_wp.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/office-security/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/office-security/3min_office_security_wp.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/office-security/3min_office_security_wp.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/office-security/3min_office_security_wp.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
