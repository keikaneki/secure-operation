...
<!-- End Google Tag Manager -->
	...
	<meta name="description" content="顔認証による勤怠連携ソリューション[セキュアプラットフォーム]の無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE ACaaS,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="顔認証による勤怠連携ソリューション[セキュアプラットフォーム]の無料資料ダウンロード" />
	...
	<meta property="og:description" content="顔認証による勤怠連携ソリューション[セキュアプラットフォーム]の無料資料ダウンロード" />
	...
	if (isset($_SESSION['NAME1'])) {
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 顔認証による勤怠連携ソリューション[セキュアプラットフォーム]資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/platform/secure_platform.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/platform/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/platform/secure_platform.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/platform/secure_platform.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/platform/secure_platform.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
