...
<!-- End Google Tag Manager -->
	...
	<title>顔認証による勤怠連携ソリューション[セキュアプラットフォーム]｜資料ダウンロード｜SECURE</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;"><span style="font-size:65%;margin-bottom:5px;">顔認証による勤怠連携ソリューション</span>Secure-Platform<br>
[セキュアプラットフォーム]</span></h1>
		  <figure><img src="./doc_thumbnail_platform.png" width="180">
		  	<figcaption style="color:#000;">顔認証による勤怠連携ソリューションで解消できる課題、業務工数削減内容をご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
