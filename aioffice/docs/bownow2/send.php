<?php
	...
	// 文字種変換
	$mail1 		= (isset($_GET['mail1'])) ? mb_convert_kana($_GET['mail1'], "as") : "";
	// 末尾空白削除
	$mail1		=rtrim($mail1);
	// セッションに入力値を代入
	$_SESSION['NAME1'] = 		htmlspecialchars($_GET['name1']);
	$_SESSION['NAME2'] = 		htmlspecialchars($_GET['name2']);
	$_SESSION['COMPANY'] = 		htmlspecialchars($_GET['company']);
	$_SESSION['MAIL1'] = 		htmlspecialchars($mail1);
	$_SESSION['PARAM'] = 		htmlspecialchars($_GET['param']);
...
<head>
	...
	<title>完了｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="簡単導入！顔認証クラウド型入退室管理システムAI Offce Baseの無料資料ダウンロード" />
...
//		$mailtoAddress = '09c26344.secureinc.co.jp@apac.teams.ms,secure-info@secureinc.co.jp';
		...
		$returnMailtoAddress = mb_convert_kana($_SESSION['MAIL1'],"aK");
				...
				$subj = "【AI Office Base】 概要資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf\n";
		...
		$mail->Body		= mb_convert_encoding(
					...
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf". "\n".
...
?>
				...
				<section class="formsection">
					<article class="mainsection ta-c">
						<div></div>
						<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf</a></p>
						<p>
