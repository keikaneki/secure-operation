...
<!-- End Google Tag Manager -->
	...
	<title>セキュアアルコールチェッカーによる本人認証＆スピーディーなアルコールチェック｜資料ダウンロード｜SECURE</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;"><span style="font-size:65%;margin-bottom:5px;"></span>SECURE ALCOHOL CHECKER<br>
[セキュアアルコールチェッカー]</span></h1>
		  <figure><img src="./doc_thumbnail_alcohol.png" width="230">
		  	<figcaption style="color:#000;">道路交通法が改正され、検知器を用いたアルコールチェックが2022年10月より義務化されました。記録データの管理や最小運用工数、リスク対策を実現するSECUREのアルコールチェッカーをご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
