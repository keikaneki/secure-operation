...
<!-- End Google Tag Manager -->
	...
	<title>完了｜資料ダウンロード｜SECURE</title>
	<meta name="description" content=セキュアアルコールチェッカーによる本人認証＆スピーディーなアルコールチェックの無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE ACaaS,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content=セキュアアルコールチェッカーによる本人認証＆スピーディーなアルコールチェックの無料資料ダウンロード" />
	<meta property="og:image" content="https://secureinc.co.jp/aioffice/images/og.png" />
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/data-center/" />
	<meta property="og:site_name" content="AI顔認証・入退室管理・監視カメラ・セキュリティは株式会社セキュア" />
	<meta property="og:description" content=セキュアアルコールチェッカーによる本人認証＆スピーディーなアルコールチェックの無料資料ダウンロード" />
	...
	if (isset($_SESSION['NAME1'])) {
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 顔認証よる本人認証＆スピーディーなアルコールチェック[セキュアアルコールチェッカー]資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/alcohol-checker/alcohol_checker.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/alcohol-checker/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/alcohol-checker/alcohol_checker.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/alcohol-checker/alcohol_checker.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/alcohol-checker/alcohol_checker.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./">資料ダウンロードフォームに戻る</a></p>
