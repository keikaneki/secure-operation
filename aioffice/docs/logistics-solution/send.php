...
<!-- End Google Tag Manager -->
	...
	<title>完了｜物流・倉庫業界向けソリューション｜資料ダウンロード｜株式会社セキュア</title>
	...
	if (isset($_SESSION['NAME1'])) {
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【株式会社セキュア】 物流・倉庫業界向けソリューション資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/logistics-solution/flyer_SECURE_logistics-solution.pdf\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/logistics-solution/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/logistics-solution/flyer_SECURE_logistics-solution.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/logistics-solution/flyer_SECURE_logistics-solution.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/logistics-solution/flyer_SECURE_logistics-solution.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../logistics-solution/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../logistics-solution/">資料ダウンロードフォームに戻る</a></p>
