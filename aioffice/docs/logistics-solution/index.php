...
<!-- End Google Tag Manager -->
	...
	<title>物流・倉庫業界向けソリューション｜資料ダウンロード｜株式会社セキュア</title>
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする物流・倉庫業界向けソリューション無料資料ダウンロード" />
	<meta name="keywords" content="入退室管理,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="物流・倉庫業界向けソリューション｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする物流・倉庫業界向けソリューション無料資料ダウンロード" />
...
物流・倉庫業界向けソリューションのご紹介</span></h1>
		  <figure><img src="./doc_thumbnail_logistics.png" width="306">
		  	<figcaption style="color:#000;">「広い敷地内の状況把握が難しい」「多数の業者が出入りするのでセキュリティを強化したい」「休憩室の混雑を緩和したい」など、物流・倉庫業界あるあるの課題に対する解決策をご提示します。</figcaption></figure>
		</div>
	  </div>
	</div>
