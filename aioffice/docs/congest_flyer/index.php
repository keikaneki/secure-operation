...
<!-- End Google Tag Manager -->
	...
	<title>混雑見える化ソリューション「混雑カウント」のご紹介｜資料ダウンロード｜株式会社セキュア</title>
	...
	<meta property="og:title" content="混雑見える化ソリューション「混雑カウント」のご紹介｜資料ダウンロード｜株式会社セキュア" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1 class="small"><span style="color:#000;"><span style="font-size:80%;"> 〜オフィスや商業施設・レストランなどに〜<br>混雑見える化ソリューション「混雑カウント」のご紹介</span></h1>
		  <figure><img src="./doc_thumbnail_congest.png" width="306">
		  	<figcaption style="color:#000;">ステレオカメラにて測定したデータを元に、これまでは肌感覚で測っていた混雑状況を見える化するサービスです。<br />混雑状況をデータとして提供するのでWebサイトやサイネージなど表示先テイストに合わせて情報を表示することが可能です。<br>本資料では混雑見える化ソリューションをご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_12ba46bd3e85186c0d0e" method="POST" accept-charset="UTF-8" >
			<!--<dl>
