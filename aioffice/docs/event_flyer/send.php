...
<!-- End Google Tag Manager -->
	...
	<title>完了｜イベント会場向け本人確認ソリューションのご紹介｜資料ダウンロード｜株式会社セキュア</title>
	<meta name=”robots” content=”noindex” />
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けするイベント会場向け本人確認ソリューションのご紹介無料資料ダウンロード" />
	<meta name="keywords" content="入退室管理,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="イベント会場向け本人確認ソリューションのご紹介｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けするイベント会場向け本人確認ソリューションのご紹介無料資料ダウンロード" />
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/docs/event_flyer/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/event_flyer/event_solution_flyer.pdf". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/event_flyer/event_solution_flyer.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/event_flyer/event_solution_flyer.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
