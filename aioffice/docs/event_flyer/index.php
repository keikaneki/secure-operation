...
<!-- End Google Tag Manager -->
	...
	<title>イベント会場向け本人確認ソリューションのご紹介｜資料ダウンロード｜株式会社セキュア</title>
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1 class="small"> <span style="color:#000;">〜イベント会場受付の本人確認を顔認証でスムースに。<br>マスク検知・測温も実現〜<br>
イベント会場向け本人確認ソリューションのご紹介</span></h1>
		  <figure><img src="./doc_thumbnail_event.png" width="306">
		  	<figcaption style="color:#000;">チケット転売問題や感染症対策で、イベントの主催者は入場時の本人確認を行う必要性が出てきています。<br>本資料では顔認証システムを利用することで人手でのID確認をなくし、非接触で入場管理ができるソリューションをご紹介します。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_4b1fc7c4870254bf8415" method="POST" accept-charset="UTF-8" >
