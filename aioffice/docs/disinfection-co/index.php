...
<!-- End Google Tag Manager -->
	...
	<title>オフィスの消毒業者・補助金まとめ（都道府県別）｜資料ダウンロード｜SECURE AI Office Base</title>
	<meta name="description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、オフィスの消毒業者・補助金まとめ（都道府県別）無料資料ダウンロード" />
	<meta name="keywords" content="ABW,オフィス3密対策,サテライトオフィス,,SECURE,SECURE AI Office Base,オフィスリモート管理,健康経営,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="オフィスの消毒業者・補助金まとめ（都道府県別）｜資料ダウンロード｜SECURE AI Office Base" />
	<meta property="og:image" content="https://secureinc.co.jp/aioffice/images/og.png" />
	<meta property="og:url" content="https://secureinc.co.jp/aioffice/docs/sokuon-flyer/" />
	<meta property="og:site_name" content="SECURE AI Office Base：社員を守り、事業も継続！職場はクラウドで管理する" />
	<meta property="og:description" content="ニューノーマル時代のリモート・AI職場運用システムのAI Offce Baseがお届けする、オフィスの消毒業者・補助金まとめ（都道府県別）無料資料ダウンロード" />
...
<!-- End Google Tag Manager (noscript) -->
  <div id="wrap">
	<div id="mv">
	  ...
	  <div id="mv__inner">
		<div>
		  <h1> <span style="color:#000;">コロナ発生後の備えに！<br />47都道府県別 オフィスの消毒業者・補助金まとめ</span></h1>
		  <figure><img src="./doc_thumbnail_disinfection-co_wp.png" width="306">
		  	<figcaption style="color:#000;">感染症対策やクラスターを出さない対策を打つことは大前提ですが、万が一オフィスからコロナ感染者が発生して日待った場合のリスク管理にお役立ち資料をご用意しました。<br />
		  オフィスでコロナ感染者が発生すると、保健所から「病原体汚染場所等消毒命令書（感染症の予防や感染症の患者に対する法律）」が発令され、オフィス内の消毒が必要となります。<br />
		 	「クラスター対策として、オフィスの消毒業者を調べておきたい……」<br />「オフィスの業務停止などに備えて、利用できる補助金や助成金も知りたい…」そんなお悩みにご活用ください。</figcaption></figure>
		</div>
	  </div>
	</div>
	<section class="formsection">
		<p class="lead">以下のフォームに必要項目を入力の上、送信していただきますと、<br>資料閲覧URLをお送りいたします。</p>
		<form id="formarea" action="https://contents.bownow.jp/forms/handler/sid_9d40f9bf802226eb700c" method="POST" accept-charset="UTF-8" >
