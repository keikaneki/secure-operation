...
//		$mailtoAddress = 'yoyuya@gmail.com';
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【AI Office Base】 消毒会社一覧資料ダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/disinfection-co/disinfection-co_wp_210115.pdf\n";
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/disinfection-co/disinfection-co_wp_210115.pdf" target="_blank">https://secureinc.co.jp/aioffice/docs/disinfection-co/disinfection-co_wp_210115.pdf</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
