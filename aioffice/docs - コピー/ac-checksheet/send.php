...
<!-- End Google Tag Manager -->
	...
	<title>完了｜資料ダウンロード｜株式会社セキュア</title>
	<meta name=”robots” content=”noindex” />
	<meta name="description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする入退室管理システム選定時のチェックシート無料ダウンロード" />
	<meta name="keywords" content="入退室管理,チェックシート,ABW,顔認証,SECURE,クラウドオフィス管理" />
	<meta property="og:type" content="website" />
	<meta property="og:title" content="完了｜資料ダウンロード｜株式会社セキュア" />
	...
	<meta property="og:description" content="AI顔認証・入退室管理、監視カメラ、セキュリティのSECUREがお届けする入退室管理システム選定時のチェックシート無料ダウンロード" />
...
//		$mailtoAddress = "yoyuya@gmail.com";
		...
		/*switch ($num) {
			case 0:
				...
				break;
			case 1:
				$subj = "入退室管理導入前チェックシートダウンロード";
				$thxmes = "ダウンロードのお申込みありがとうございました";
				break;
		}*/
				$subj = "【株式会社セキュア】 入退室管理導入前チェックシートダウンロード通知";
				$thxmes = "資料ダウンロードのお申込みありがとうございました。\nこちらより閲覧いただけます。\nhttps://secureinc.co.jp/aioffice/docs/ac-checksheet/ac-checksheet.xlsx\n";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					//"【 お問い合わせ種別 】 ".			$typePrint . "\n".
					"【 訪問サイト 】 https://secureinc.co.jp/aioffice/ac-checksheet/". "\n".
					"【 ダウンロード資料 】 https://secureinc.co.jp/aioffice/docs/ac-checksheet/ac-checksheet.xlsx". "\n".
...
?>
	...
	<section class="formsection">
		<article class="mainsection ta-c">
			<div></div>
			<p>送信が完了しました<br><br>資料ダウンロードのお申込みありがとうございました。<br>こちらより閲覧いただけます。<br><a href="https://secureinc.co.jp/aioffice/docs/ac-checksheet/ac-checksheet.xlsx" target="_blank">https://secureinc.co.jp/aioffice/docs/ac-checksheet/ac-checksheet.xlsx</a></p>
			<p>
<?php
				//if ($num == 0) {
					// 正常処理 | 種別：お問い合わせ
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../ac-checksheet/">資料ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="../ac-checksheet/">資料ダウンロードフォームに戻る</a></p>
