	...
	if(!$num){
		...
		/*switch ($num) {
			...
			case 1:
				...
				$subj = "【AI Office Base】 資料請求・お問い合わせフォームの送信がありました";
...
//		$mail->AddCC($mailCcAddress);
		$mail->Body		= mb_convert_encoding(
					...
					//"【 部署名 】 ". 					mb_convert_kana($_SESSION['DEPARTMENT'],"aK") . "\n".
					...
					"【 デモ希望 】 ". 				mb_convert_kana($_SESSION['DEMO'],"aK") . "\n".
					"【 導入予定時期 】 ". 				$typePrint . "\n".
					"【 お問い合わせ内容 】 ". 		mb_convert_kana($_SESSION['BODY'],"aK") . "\n\n".
					"------------------------------\n".
					"株式会社セキュア\n".
					"tel:03-6911-0660\n".
		...
		if ( $mail->send() ) {
			$mail->ClearAddresses();
			$mail->FromName		= mb_encode_mimeheader($fromUserName,"ISO-2022-JP","UTF-8"); // "表示名" <メールアドレス>
			$mail->Subject		= mb_encode_mimeheader("【AI Office Base】 資料請求・お問い合わせありがとうございます","ISO-2022-JP", "UTF-8");
...
?>
			...
			<p>こちらより資料をご覧いただけます。<br>
				<a href="https://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf">https://secureinc.co.jp/aioffice/docs/aiob3min/aiob_overview.pdf</a><br><br>
			...
			<p>
				完了メールが届かない場合、処理が正常に行われていない可能性があります。<br>
				大変お手数ですが、再度ダウンロードフォームから送信いただくか、<br>
				お急ぎの場合はお電話でお問い合わせいただくようお願い致します。
			</p>
<?php
				//}
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./index.php#form">ダウンロードフォームに戻る</a></p>
...
?>
	...
	<section class="formsection">
		<article class="mainsection">
			...
			<p>お手数ですが再度フォームから情報を入力して送信してください。<br><br><a style="text-decoration:underline;" href="./index.php#form">ダウンロードフォームに戻る</a></p>
...
?>
			...
			<p class="tocontact"><a href="./index.php#form_b" class="btn"><span>お問い合わせフォーム</span></a></p>
		</article>
