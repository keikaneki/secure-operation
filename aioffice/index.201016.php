...
<head>
	...
	<title>SECURE AI Office Base：社員を守り、事業も継続！オフィスはクラウドで管理する</title>
...
<!-- End Google Tag Manager (noscript) -->
	<div id="wrap">
		<div id="mv">
			...
			<div id="mv__inner">
				<h2><strong>やっぱり<br class="min-view">オフィスは必要だと気づいてしまった方へ</strong></h2>
				<div>
					<h1> <span>社員を守り、事業も継続！<br>オフィスはクラウドで管理する</span></h1>
					<p><a class="btn" href="https://airrsv.net/ai-officebase/calendar" target="_blank"><img src="./images/icon_demo.svg" width="25" /><span>オンラインデモ・<br>ショールーム見学を依頼する</span></a><a class="btn" href="#"><img src="./images/icon_video.svg" width="26" /><span>動画での説明を見る</span></a></p>
				</div>
			</div>
			<div class="dl">
				<div class="inner">
					<figure><img src="./images/doc_thumbnail.png" /></figure>
					<p><small>オフィスセキュリシステム会社が考えた安心できるオフィスのガイドライン</small><span>ニューノーマル時代のオフィスあり方虎の巻</span></p><a class="btn" href="./docs/toranomaki/"><img src="./images/icon_dl.svg" width="18" /><span>無料ダウンロード</span></a>
				</div>
			</div>
		</div>
		<section id="worries">
			...
			<div class="inner">
				<h2 id="anchor-1">今後のオフィス、<br class="min-view">どうすれば良いの？</h2>
				<ul>
					<li><img src="./images/img_1_1.png" /><span>オフィスの3密対策<br>どうするの？</span></li>
					<li><img src="./images/img_1_2.png" /><span>オフィスの管理とセキュリティ<br>はどうしたらいいの？</span></li>
		...
		<section id="whatis">
			...
			<div class="inner">
				...
				<p class="lead">SECURE AI Office Baseはオフィスのあり方が多様化する時代に、<br class="pc-view">AIを活用して社員の安全と働きやすさを追求する企業向け「リモートオフィス運営クラウドシステム」です。<br />従業員規模数十名から千人超えの企業まで幅広く対応することが可能です。</p>
				<div class="carousel">
					<div class="device-pc">
						<div class="item-wrap">
		...
		<section id="suggest">
			<div class="bg-white-top"></div>
			<div class="inner">
				<h2 id="anchor-3">新しいオフィス運用のご提案</h2>
				<p class="lead">SECURE AI Office Baseがニューノーマル時代のオフィスのあり方を提唱します。<br>　オフィスのフリーアドレス化やサテライトオフィスの活用、場所を自由に選択して働くABW（Activity Based Working）といった今までにない多様性のある働き方ができるオフィスをスピーディに構築。</p>
			...
			<div class="inner">
				...
				<div class="row">
					...
					<div class="row__item">
						...
						<h3>混雑可視化 ＋ オフィス稼働分析</h3>
						<p>オフィスの混雑状況を<br>自宅からリモート監視</p>
					</div>
				</div>
				<h3>社員とオフィスの安心安全な環境を<br class="min-view">構築する機能</h3>
				<ul class="card large">
				...
				<h3>オフィスのデジタル化の運用機能</h3>
				<ul class="card large">
					<li><img src="./images/img_4_4.jpg" />
						<h4>少人数かつリモートでオフィス運営</h4>
						<ul>
							<li>来客対応不要</li>
							<li>入退室カード管理不要</li>
						</ul>
				...
				<ul class="card small">
					...
					<li ontouchstart="">
						<div>
							<p><span>ダッシュボード</span></p><small>登録情報の表示<br>オフィス内の混雑情報表示<br>オフィスアの利用率表示<br>認証ログの表示<br>エラーログの表示<br>解析ログの表示<br></small>
						</div>
					</li>
					<li ontouchstart="">
						<div>
							<p><span>分析</span></p><small>顔温度異常検出<br>入退室異常検出<br>オフィス使用率分析<br>混雑度分析<br>表情分析<br>勤怠分析</small>
						</div>
					</li>
					<li ontouchstart="">
						<div>
		...
		<div id="util">
			<div class="bg-white-top"></div>
			<div class="inner">
				<h2 id="anchor-6">オフィス以外のこんな場所でも<br class="min-view">活用可能</h2>
				<ul>
					<li>
		...
		<div id="form">
			...
			<div class="inner">
				...
				<section class="formsection">
					<form id="formarea" method="post" action="confirm.210106.php">
			<!--<dl>
						...
						<dl>
							...
							<dd>
								...
								<ul>
									<li>
										<label>
											<input type="checkbox" name="kind[]" id="kind1" value="資料請求" v-model="kind" @blur="kindcng" /><span>資料請求</span>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" name="kind[]" id="kind2" value="デモ依頼" v-model="kind" @blur="kindcng" /><span>デモ依頼</span>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" name="kind[]" id="kind3" value="見積もり依頼" v-model="kind" @blur="kindcng" /><span>見積もり依頼</span>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" name="kind[]" id="kind4" value="導入を検討したい" v-model="kind" @blur="kindcng" /><span>導入を検討したい</span>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" name="kind[]" id="kind5" value="顧客に提案したい" v-model="kind" @blur="kindcng" /><span>顧客に提案したい</span>
										</label>
									</li>
								</ul>
							</dd>
