! function (i) {
  ...
  s = 0, (r = function (i, e) {
    ...
    if ("window" === n.respondTo ? s = a : "slider" === n.respondTo ? s = l : "min" === n.respondTo && (s = Math.min(a, l)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
      ...
      null !== o ? null !== n.activeBreakpoint && o === n.activeBreakpoint && !e || (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = d.extend({}, n.originalSettings, n.breakpointSettings[o]), !0 === i && (n.currentSlide = n.options.initialSlide), n.refresh(i)), r = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === i && (n.currentSlide = n.options.initialSlide), n.refresh(i), r = o), i || !1 === r || n.$slider.trigger("breakpoint", [n, r])
    }
    ...
    var i, e, t, o, s, n = this,
      r = !1;
    if ("object" === d.type(arguments[0]) ? (t = arguments[0], r = arguments[1], s = "multiple") : "string" === d.type(arguments[0]) && (o = arguments[1], r = arguments[2], "responsive" === (t = arguments[0]) && "array" === d.type(arguments[1]) ? s = "responsive" : void 0 !== arguments[1] && (s = "single")), "single" === s) n.options[t] = o;
...
function (i) {
  ...
  function e() {
    if (c.length) {
      var i = 0,
        e = l.map(c, function (i) {
          var e = i.data.selector,
            t = i.$element;
          return e ? t.find(e) : t
        });
      for (a = a || function () {
          ...
          return t.height || (!(i = p.compatMode) && l.support.boxModel || (t = {
            height: (e = "CSS1Compat" === i ? h : p.body).clientHeight,
            width: e.clientWidth
          })), t
        }(), d = d || {
          top: u.pageYOffset || h.scrollTop || p.body.scrollTop,
          left: u.pageXOffset || h.scrollLeft || p.body.scrollLeft
        }; i < c.length; i++)
        if (l.contains(h, e[i][0])) {
          var t = l(e[i]),
            o = t[0].offsetHeight,
            s = t[0].offsetWidth,
            n = t.offset(),
            r = t.data("inview");
          if (!d || !a) return;
          n.top + o > d.top && n.top < d.top + a.height && n.left + s > d.left && n.left < d.left + a.width ? r || t.data("inview", !0).trigger("inview", [!0]) : r && t.data("inview", !1).trigger("inview", [!1])
        }
    }
  }
  var a, d, o, c = [],
    ...
    u = window,
    h = p.documentElement;
  l.event.special.inview = {
    add: function (i) {
      c.push({
        data: i,
        $element: l(this),
        element: this
      }), !o && c.length && (o = setInterval(e, 250))
    },
    remove: function (i) {
      for (var e = 0; e < c.length; e++) {
        var t = c[e];
        if (t.element === this && t.data.guid === i.guid) {
          c.splice(e, 1);
          break
        }
      }
      c.length || (clearInterval(o), o = null)
    }
  }, l(u).on("scroll resize scrollstop", function () {
    a = d = null
  }), !h.addEventListener && h.attachEvent && h.attachEvent("onfocusin", function () {
    d = null
  })
}), $(function () {
  var i, e, t = document.body.clientWidth;
  $(window).bind("load", function () {
      t < 639 ? ($(".js-block").click(function () {
        return window.location = $(this).find(".btn").attr("href"), !1
      }), function () {
        var i = $(".js-telto"),
          e = i.attr("data-telno");
        console.log(e), i.wrap("<a href=tel:" + e + ' class="telto" targer="_parent">')
      }()) : $(".gnav:not(.plain)").hover(function () {
        $(this).find(".snavabout, .snav").addClass("show"), $(".mask").addClass("show")
      }, function () {
        $(".snavabout, .snav").removeClass("show"), $(".mask").removeClass("show")
      })
    }), $('a[href^="#"]').click(function () {
      var i = $(this).attr("href"),
        e = $("#" == i || "" == i ? "html" : i).offset().top - 120;
      return $("html, body").animate({
        scrollTop: e
      }, 500, "swing"), !1
    }), $(window).on("scroll", function () {
      var i = $(document).innerHeight() - $(window).innerHeight(),
        e = $(window).scrollTop();
      i <= e ? $("header:not(.nonav)").addClass("fix") : $("header:not(.nonav)").removeClass("fix"), 100 < e ? $("header").addClass("shadow") : $("header").removeClass("shadow")
    }), $(".pagetop").click(function () {
      return $("body, html").animate({
        scrollTop: 0
      }, 800), !1
    }), i = null, e = $(".switch"), $(window).on("load resize", function () {
      clearTimeout(i), i = setTimeout(function () {
        var i = $(window).width();
        e.each(function () {
          i < 639 ? $(this).attr("src", $(this).attr("src").replace("pc", "sp")) : $(this).attr("src", $(this).attr("src").replace("sp", "pc"))
        })
      }, 200)
    ...
    function () {
      ...
      $(".menubtn").on("click", function () {
        0 == i ? (e = $(window).scrollTop(), t.css({
          position: "fixed",
          width: "100%",
          "z-index": "1",
          top: -e
        }), $("header").addClass("js-openmenu"), $(".menu").addClass("fix"), $("header:not(.nonav)").addClass("fix"), i = !0, console.log(e)) : (t.css({
          position: "relative",
          width: "auto",
          top: "auto"
        }), $("html, body").scrollTop(e), console.log(e), $("header").removeClass("js-openmenu"), $(".menu").removeClass("fix"), $("header:not(.nonav)").removeClass("fix"), $(".openmenu").scrollTop(0), i = !1)
      });
      var e, t = $("body")
    }(), /*$(".js-filter").click(function(){var i=$(this).attr("data-filter");"all"==i?$(".case-list .col").fadeIn():($(".case-list .col").hide(),$("."+i).fadeIn())}),*/ $(".js-accordion").click(function () {
      $(this).parent().find("ul").slideToggle(), $(this).toggleClass("open"), console.log("open")
    })
}), $(function () {
  var i = document.body.clientWidth;
  $(window).on("load resize", function () {
    i < 639 ? $(".js-slide-sp").slick({
      autoplay: !0,
      autoplaySpeed: 5e3,
      infinite: !0,
      cssEase: "linear",
      ...
      $.each($("a"), function (i, elem) {
        ...
        if (!$(elem).data("paramed")) {
          ...
          if (href.includes("secureinc") || href.startsWith("/") || href.startsWith(".")) {
            if (href.indexOf("page=") >= 0) {} else if (href.indexOf("?") >= 0) {
              //最初からパラメータ付きのリンクなら
              //そのまま追加
