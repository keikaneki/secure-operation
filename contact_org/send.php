	...
	if (isset($_SESSION['NAME1'])) {
		...
		switch ($num) {
			case 0:
				...
				break;
			case 1:
				$subj = "3分で分かる「オフィスセキュリティ」ダウンロード";
				$thxmes = "ダウンロードのお申込みありがとうございました。ダウンロードURL　https://lp.secureinc.co.jp/rs/531-QPX-295/images/OfficeSecurityfor3min.pdf　";
				break;
		}
...
?>
			...
			<div class="dlbox">
				<a href="/download/OfficeSecurity3min.pdf" class="btn orange shadow">
					3分で分かる「SECURE」<br>
